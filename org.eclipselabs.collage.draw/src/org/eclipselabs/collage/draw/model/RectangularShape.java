...
public class RectangularShape extends VariableLineWidthShape {
	@Override
	public Image getIcon() {
		return DrawActivator.getImage(DrawActivator.RECTANGLE_ICON);
	}

	@Override
	public String toString() {
		return "Rectangle (" + getShapeBoundariesDescription() + ")";
	}
}
