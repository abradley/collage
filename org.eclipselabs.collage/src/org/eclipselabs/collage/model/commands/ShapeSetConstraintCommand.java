...
public class ShapeSetConstraintCommand extends Command {
	...
	public boolean canExecute() {
		if (shape != null && shape.isCreated() && !shape.isDeleted() && shape.inActiveLayer()) {
	...
	public boolean canUndo() {
		return shape.isCreated() && !shape.isDeleted() && shape.getBoundaries().equals(newBounds) && shape.inActiveLayer();
	}
