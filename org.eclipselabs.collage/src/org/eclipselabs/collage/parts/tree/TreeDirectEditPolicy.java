 ...
 *     Alex Bradley    - adapted for use with TreeEditParts
 *******************************************************************************/
...
/**
 * <p>Shows DirectEdit feedback and creates the Command to perform a "direct edit".
 ...
 * 
 * <p>(This class is the same as {@link DirectEditPolicy}, except that it 
 * extends {@link AbstractEditPolicy} instead of {@link GraphicalEditPolicy} and 
 * can therefore be used with {@link TreeEditPart}s.
 * 
 * @author hudsonr
 * @author Alex Bradley
 */
public abstract class TreeDirectEditPolicy extends AbstractEditPolicy {
